...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/auto/Control/src/control)
  set(control_DEVEL_PREFIX /home/auto/Control/devel)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /home/auto/Control/install)
...
if(NOT "/home/auto/Control/devel/include;/home/auto/Control/src/control/include " STREQUAL " ")
  set(control_INCLUDE_DIRS "")
  set(_include_dirs "/home/auto/Control/devel/include;/home/auto/Control/src/control/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'xianli <xianli@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/auto/Control/src/control/${idir}'.  ${_report}")
    endif()
    _list_append_unique(control_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "control")
...
set(depends "roscpp;std_msgs;autoware_msgs;sensor_msgs;geometry_msgs;message_runtime")
